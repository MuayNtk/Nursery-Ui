    ...
    <>
      ...
      <Grid container spacing={1} justifyContent='start' className="pt-5">
        <Grid item xs={3} sm={4} md={3} lg={3} >
          <Typography fontWeight='bold' component="div" sx={{ fontSize: { xs: 11, sm: 11, md: 11, lg: 16, } }} >
            改善前 :
          </Typography>
        </Grid>
      </Grid>
      ...
      {/* Start Textarea-before-improvement */}
      <Grid container rowSpacing={2} justifyContent='start' alignItems='start' className='pt-2'>
        <Grid item xs={9} sm={9} md={8.5} lg={6}>
          <TextareaAutosize
      ...
      {/* End Textarea-before-improvement */}
      ...
      {/* Start Textarea-after-improvement */}
      <Grid container rowSpacing={2} justifyContent='start' alignItems='start' className='pt-2'>
        <Grid item xs={9} sm={9} md={8.5} lg={6}>
          <TextareaAutosize
      ...
      {/* End Textarea-after-improvement */}
