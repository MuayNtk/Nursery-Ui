    ...
    <>
      ...
      <Grid container justifyContent="center">
        <TableContainer component={Paper} className="mt-2" sx={{ width: { xs: 'auto', sm: 'auto', md: 'auto', lg: 'auto' } }}>
          <Table sx={{ minWidth: 1400 }} aria-label="simple table" size="small">
            <TableHead>
              <TableRow>
              ...
              <TableRow>
                <TableCell style={{ fontWeight: "bold" }} align="center">4月</TableCell>
                <TableCell style={{ fontWeight: "bold" }} align="center">5月</TableCell>
                <TableCell style={{ fontWeight: "bold" }} align="center">6月</TableCell>
                <TableCell style={{ fontWeight: "bold" }} align="center">7月</TableCell>
                <TableCell style={{ fontWeight: "bold" }} align="center">8月</TableCell>
                <TableCell style={{ fontWeight: "bold" }} align="center">9月</TableCell>
                <TableCell style={{ fontWeight: "bold" }} align="center">10月</TableCell>
                <TableCell style={{ fontWeight: "bold" }} align="center">11月</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {/* Start Rows 1 */}
