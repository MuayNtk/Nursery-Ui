...
export default function AdditionalForm() {
  ...
  return (
    <>
      ...
      <Grid container className='pt-5' justifyContent="start" >
        <Grid item xs={6} sm={6} md={3} lg={6} className=' 'sx={{ ml: { xs: -6, sm: -5, md: -1, lg:-16 } }} >
        <TextareaAutosize
            id="emotional-input"
        ...
        <Grid item xs={3} sm={3} md={4} lg={4} className=' ' >
          <Typography
            component="div"
            sx={{ color: 'black', fontSize: { xs: 11, sm: 11, md: 11, lg: 16 },marginLeft: { xs: -4, sm: -2, md: 20, lg: 16, } }}
        ...
        <TextField
              ...
              sx={{
                ...
                marginLeft: { xs: 1, sm: 1, md: 4, lg: -1, }
              }}
            />
        </Grid>
      </Grid>
