...
export default function WageAdjustmentsThree() {
      ...
      <Grid container className='pt-3' justifyContent="start">
        <Grid item xs={12} sm={12} md={12} lg={12}>
          <Typography fontWeight="bold" sx={{ fontSize: { xs: '14px', sm: '14px', md: '14px', lg: '15px' } }} className='pt-2 text-start'>
      ...
      <Grid container className='pt-6' justifyContent="center">
        <TableContainer component={Paper} className="" sx={{ width: { xs: 'auto', sm: 'auto', md: 'auto', lg: 'auto' } }}>
          <Table sx={{ minWidth: 2000 }} aria-label="simple table">
            <TableHead >
              <TableRow>
                <TableCell style={{ width: 100, fontWeight: 'bold', }} align="center"></TableCell>
                <TableCell style={{ width: 200, fontWeight: 'bold', }} align="center"></TableCell>
                <TableCell style={{ width: 200, fontWeight: 'bold', }} align="center"></TableCell>
                <TableCell style={{ width: 400, fontWeight: 'bold', }} align="center"></TableCell>
                <TableCell style={{ width: 400, fontWeight: 'bold', }} align="center" colSpan={2}>常勤換算值 ※3</TableCell>
                <TableCell style={{ width: 400, fontWeight: 'bold', }} align="center"></TableCell>
                <TableCell style={{ width: 400, fontWeight: 'bold', }} align="center"></TableCell>
                <TableCell style={{ width: 400, fontWeight: 'bold', }} align="center"></TableCell>
                <TableCell style={{ width: 200, fontWeight: 'bold', }} align="center"></TableCell>
            ...
            <TableHead >
              <TableRow>
                <TableCell style={{ width: 100 }} align="center">No.</TableCell>
                <TableCell style={{ width: 200 }} align="center">職員名</TableCell>
                <TableCell style={{ width: 200 }} align="center">職種 ※1</TableCell>
                <TableCell style={{ width: 200 }} align="center">職種</TableCell>
                <TableCell style={{ width: 200 }} align="center">常勤</TableCell>
                <TableCell style={{ width: 200 }} align="center">非常勤</TableCell>
                <TableCell style={{ width: 200 }} align="center">法人役員 との兼務</TableCell>
                <TableCell style={{ width: 200 }} align="center">加算皿による賃金改善見込 額※4</TableCell>
                <TableCell style={{ width: 200 }} align="center">基本給及び決て毎月支手当</TableCell>
                <TableCell style={{ width: 200 }} align="center">その他</TableCell>
                <TableCell style={{ width: 200 }} align="center">賃金改善に伴い増加する法定福利費等の事業主負担分 ※5</TableCell>
                <TableCell style={{ width: 200 }} align="center">備考 ※6</TableCell>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell style={{ width: 200, }} align="center">00 00</TableCell>
                <TableCell style={{ width: 200, }} align="center"><FormControl size="small" className="w-20">
      ...
      <Grid container className='pt-3' justifyContent="start">
        <Grid item xs={12} sm={12} md={12} lg={12}>
          <Typography fontWeight="bold" sx={{color: '#EEC636', fontSize: { xs: '12px', sm: '14px', md: '14px', lg: '14' } }} className='pt-2 text-justify'>
          【記入における留意事項】
          </Typography>
        </Grid>
      </Grid>
      ...
      <Grid container className='' justifyContent="start">
        <Grid item xs={12} sm={12} md={12} lg={12}>
          <Typography  sx={{color: 'black', fontSize: { xs: '12px', sm: '14px', md: '12px', lg: '12' } }} className='pt-2 text-justify'>
