...
export default function ResultsEarningsListOne() {
  ...
  return (
    <>
        ...
        <TableContainer component={Paper} className="mt-5" sx={{ width: { xs: 'auto', sm: 'auto', md: 'auto', lg: 'auto' } }}>
          <Table sx={{ minWidth: 600 }} aria-label="simple table">
            <TableBody>
              ...
              {/* Start Rows1 */}
              <TableRow>
                <TableCell align="left" style={{ width: 230 }}>施設・事業所名</TableCell>
      ...
      {/* Start 同一事業者内における拠出見込額・受入見込額一覧表 Grid */}
      ...
      {/* End 同一事業者内における拠出見込額・受入見込額一覧表 Grid */}
