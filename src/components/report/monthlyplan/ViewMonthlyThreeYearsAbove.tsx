...
interface ViewMonthlyThreeYearsAboveProps {
    pid: string;
    selectedOption: string;
}

const ViewMonthlyThreeYearsAbove: React.FC<ViewMonthlyThreeYearsAboveProps> = () => {
