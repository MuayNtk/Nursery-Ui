...
interface WeeklyplanOverOneProps {
  selectedOption: string;
}

const WeeklyplanOverOne: React.FC<WeeklyplanOverOneProps> = ({ selectedOption }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const currentData = JSON.parse(sessionStorage.getItem('WeeklyDataOverOne') || '[]');
    sessionStorage.setItem('WeeklyDataOverOne', JSON.stringify([...currentData, formData]));
...
export default WeeklyplanOverOne;
