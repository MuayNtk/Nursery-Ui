...
interface EditWeeklyUnderTenProps {
    pid: string;
    selectedOption: string;
}

const EditWeeklyUnderTen: React.FC<EditWeeklyUnderTenProps> = ({ pid, selectedOption }) => {
    ...
    const handleSave = () => {
        ...
        sessionStorage.setItem('WeeklyDataUnderTen', JSON.stringify(updatedData));
...
export default EditWeeklyUnderTen;