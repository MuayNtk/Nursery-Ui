      ...
      return (
            <ContentMain >
                  <Grid container spacing={3} className='pt-7' >
                        ...
                        <Grid item xs={6} sm={6} md={6} lg={3}>
                              <Button variant="contained" href="/report/annualplan" className='w-full h-10'>
                                    <Typography component="div" sx={{ color: 'white', paddingLeft: '10px', fontSize: { xs: 11, sm: 11, md: 11, lg: 16, }, }} >
                                          年間指導計画
                                    </Typography>
                              </Button>
                        ...
                        <Grid item xs={6} sm={6} md={6} lg={3}>
                              <Button variant="contained" href="/report/monthlyplan" className='w-full h-10'>
                                    <Typography component="div" sx={{ color: 'white', paddingLeft: '10px', fontSize: { xs: 11, sm: 11, md: 11, lg: 16, }, }} >
                                          月指導計画
                                    </Typography>
                              </Button>
                        ...
                        <Grid item xs={6} sm={6} md={6} lg={3}>
                              <Button variant="contained" href="report/weeklyplan" className='w-full h-10'>
                        ...
                        <Grid item xs={6} sm={6} md={6} lg={3}>
                              <Button variant="contained" href="/report/carediary" className='w-full h-10'>
                                    <Typography component="div" sx={{ color: 'white', paddingLeft: '10px', fontSize: { xs: 10, sm: 10, md: 10, lg: 14, }, }} >
                                          個人カリキュラム・記録
                                    </Typography>
                              </Button>
