...
export default function ContentMain({ children, className }: ContentMainProps) {
    ...
    const breadcrumbMap: Record<string, BreadcrumbItem[]> = {
      ...
      "/teacher/leaveadd": [
        ...
        },
        {
          label: "休暇届",
          href: "#",
          icon: <InsertInvitationOutlinedIcon fontSize="small" />,
        },
      ],
      "/student": [
        {
      ...
      "/accounting/careertraining": [
        ...
        {
          label: "リスト",
          href: "/accounting/careertraining",
          icon: <ArticleIcon fontSize="small" />,
        },
      ],
      ...
      "/accounting/rateapplication": [
        ...
        {
          label: "リスト",
          href: "/accounting/rateapplication",
          icon: <ArticleIcon fontSize="small" />,
        },
      ],
      ...
      "/accounting/requestbenefits": [
        ...
        {
          label: "リスト",
          href: "/accounting/requestbenefits",
          icon: <ArticleIcon fontSize="small" />,
        },
      ],
      ...
      "/accounting/eligiblepersons": [
        ...
        {
          label: "リスト",
          href: "/accounting/eligiblepersons",
          icon: <ArticleIcon fontSize="small" />,
        },
      ],
  ...
  <div
    className="
      ...
      px-[clamp(12px,2vw,24px)]                      /* gutter ซ้าย-ขวา บนมือถือ */
      sm:pl-[calc(var(--sidebar-w)+clamp(12px,2vw,24px))] /* เลี่ยง sidebar + gutter */
      sm:pr-[clamp(12px,2vw,32px)]                   /* gutter ขวา */
    "
  >
    ...
    <main
      className={`w-full overflow-y-auto p-4 bg-slate-50 mt-2 mb-2 min-h-screen ${className || ""}`}
    >
      {children}
    </main>
  </div>
